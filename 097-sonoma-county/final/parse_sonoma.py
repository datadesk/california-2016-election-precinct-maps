...
with open(sys.argv[1].replace('pdf','txt')) as file:
	...
	resultstring = re.sub(r'()(.*\n)+?(\d{4} )',r'\3','%s' % file.read(),flags=re.MULTILINE)
	print resultstring
	...
	resultstring = re.sub(r'(\d{4})( .+?,)',r'\1,',resultstring)
	...
	column_names = ['pct16','reg','ballots','turnout','pres_stein','pres_clinton','pres_lariva','pres_trump','pres_johnson']
	# column_names = ['pct16','reg','ballots','turnout','pres_koltikoff','pres_maturen','pres_mcmullin','pres_sanders','pres_white']
	# column_names = ['pct16','reg','ballots','turnout','ussenate_sanchez','ussenate_harris']	
	# column_names = ['pct16','reg','ballots','turnout','prop51_yes','prop51_no','prop52_yes','prop52_no','prop53_yes','prop53_no','prop54_yes','prop54_no','prop55_yes','prop55_no','prop56_yes','prop56_no']
	# column_names = ['pct16','reg','ballots','turnout','prop57_yes','prop57_no','prop58_yes','prop58_no','prop59_yes','prop59_no','prop60_yes','prop60_no','prop61_yes','prop61_no','prop62_yes','prop62_no']
	# column_names = ['pct16','reg','ballots','turnout','prop63_yes','prop63_no','prop64_yes','prop64_no','prop65_yes','prop65_no','prop66_yes','prop66_no','prop67_yes','prop67_no']
